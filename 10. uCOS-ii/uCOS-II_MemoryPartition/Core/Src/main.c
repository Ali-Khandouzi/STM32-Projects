...
/* Definition of Task Priorities -------------------------------------------- */
#define PARTITION_SIZE  32       	// Size of each memory block
#define PARTITION_COUNT 8       	// Number of blocks

/* Definition of Memory Partitions ------------------------------------------ */
OS_MEM *CommMem;           		// Memory partition structure
INT32U CommBuf[PARTITION_COUNT][PARTITION_SIZE];
INT8U *CommMsg;
